...
const SimpleFacebookIcon = (props) => (
  ...
  >
    ...
    <path d="M12 2.163c3.204 0 3.584.013 4.85.071
      1.402.063 2.122.257 2.651.464
      .674.257 1.228.618 1.772 1.162
      .544.545.905 1.098 1.162 1.771
      .206.529.401 1.248.464 2.652
      .058 1.266.071 1.646.071 4.85
      s-.013 3.584-.071 4.85
      c-.063 1.402-.257 2.122-.464 2.651
      -.257.674-.618 1.228-1.162 1.772
      -.545.544-1.098.905-1.771 1.162
      -.529.206-1.248.401-2.652.464
      -1.266.058-1.646.071-4.85.071
      s-3.584-.013-4.85-.071
      c-1.402-.063-2.122-.257-2.651-.464
      -.674-.257-1.228-.618-1.772-1.162
      -.544-.545-.905-1.098-1.162-1.771
      -.206-.529-.401-1.248-.464-2.652
      -.058-1.266-.071-1.646-.071-4.85
      ...
      .545-.544 1.098-.905 1.771-1.162
      .529-.206 1.248-.401 2.652-.464
      1.266-.058 1.646-.071 4.85-.071z" />

    {/* Facebook "f" */}
    <path
      d="M13.2 8.5h2V6.2h-2.3c-2.2 0-3.4 1.3-3.4 3.3v2H7.8v2.3h1.7V18h2.4v-4.2h2.2l.3-2.3h-2.5V9.8c0-.8.2-1.3 1.3-1.3z"
      fill="#fff"
    />
  </svg>
);
